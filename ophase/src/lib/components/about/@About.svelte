    ...
    <section class="mb-10">
        ...
        <div class="md:flex">
            <div class="inline-block md:mr-8 text-justify md:mb-0 mb-5">
                ...
                sondern auch Wandern, einfach mal ein Bierchen am AKK (dem
                Uni-eigenen Biergarten ;)) trinken, im Park brunchen, über Ethik
                und Philosphie diskutieren und tatsächlich auch lernen und
                studieren :D
                <br /><br />
                Besonders viel Wert legen wir auf ein harmonisches Miteinander in
                dem jeder so akzeptiert wird, wie er ist. Durch diese Philosphie
                hat sich mittlerweile ein großer Freundeskreis rund um unsere O-Phasengruppe
                entwickelt, welcher weit über die O-Phase hinaus geht. Das führt
                uns zu:
            </div>
            <img
    ...
    <section class="mb-10">
        ...
        <div class="">
            <div class="text-justify">
                ...
                bist du bei uns gold-(oder besser grün-)richtig ;)
                <br /><br />
